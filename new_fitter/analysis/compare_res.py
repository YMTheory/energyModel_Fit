...
if __name__ == "__main__":
    ...
    filename3 = "/junofs/users/miaoyu/energy_model/energyModel_Fit/new_fitter/output/NewgamNewB12_kSimQ_kNewAnaCer_kNew/NewgamNewB12_kSimQ_kNewAnaCer_kNew_rescov.txt"
    ...
    filename2 = "/junofs/users/miaoyu/energy_model/energyModel_Fit/new_fitter/output/NewgamB12NewMicwhole_kSimQ_kNewAnaCer_kNew/NewgamB12NewMic_kSimQ_kNewCerAna_kNew_rescov.txt"
    ...
    ax.errorbar(elecE/Y, elecRes, yerr=elecReserr, fmt="o", ms=6, color="blue", label="Simulation", zorder=3)
    #ax.plot(Evis, res1, "-", lw=2, color="crimson", label="only gamma", zorder=1)
    #ax.plot(Evis, res2, "-", color="black", label="gamma + B12", zorder=2)
    ax.plot(Evis, res3, "-", lw=2, color="crimson", label="Fitting", zorder=1)
    ...
    ax.fill_between(Evis, res3-10*del3min, res3+10*del3max, color="slategray", alpha=0.5)
    #ax.set_xlim(0.9, 2)
